...
export default async function ProductDetailPage({ params }: ProductDetailPageProps) {
  ...
  // Split long_description into bullet points if it contains bullet markers
  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        style={{
          background: "linear-gradient(135deg, #0f172a 0%, #1e3a5f 40%, #2d6a8a 70%, #4a9bb5 100%)",
        }}
      >
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-24">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-4xl font-bold leading-tight tracking-tight text-white md:text-5xl lg:text-5xl">
                {product.name}
              </h1>
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-5">
              ...
              <h2 className="text-3xl font-bold tracking-tight text-gray-900">
                The 5-Star Blueprint
              </h2>
              {hasBullets && introParagraphs.length > 0 ? (
            ...
            <div className="space-y-4 lg:pt-12">
              {hasBullets && bulletPoints.length > 0 ? (
                ...
                <>
                  {[
                    "The mindset shift from driver to business owner",
                    "The ratings strategy that earns 5 stars consistently",
                    "The communication framework for better tips",
                    "The income system to maximize every hour",
                    "Rookie mistakes that cost you money — and how to avoid them",
                  ].map((feature, idx) => (
                    <div key={idx} className="flex items-start gap-3">
                      <span className="mt-0.5 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-teal-100 text-teal-600">
                        <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
