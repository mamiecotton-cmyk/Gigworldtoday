        ...
        <div className="relative mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-24">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="space-y-6">
              ...
              <div
                className="max-w-lg text-base leading-relaxed text-gray-300 sm:text-lg prose prose-invert [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:my-1"
                dangerouslySetInnerHTML={{ __html: fixQuillLists(product.short_description || "") }}
              />
