...
export default function Footer() {
  return (
    <footer className="border-t mt-20">
      ...
      <div className="border-t text-center text-xs text-gray-500 py-4 flex flex-col items-center gap-2">
        <a
